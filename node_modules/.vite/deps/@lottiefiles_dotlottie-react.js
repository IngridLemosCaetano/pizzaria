...
var i0 = (() => {
  ...
  return function(i = {}) {
    ...
    function D1(t) {
      var _a2;
      throw (_a2 = s.onAbort) == null ? void 0 : _a2.call(s, t), t = "Aborted(" + t + ")", $(t), s1 = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), P(t), t;
    }
    ...
    w2 = A2, g = s.BindingError = class extends Error {
      ...
      var _a2;
      (_a2 = this.Ya) == null ? void 0 : _a2.call(this, t);
...
` + n.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    (async function() {
      ...
      function t(n) {
        var _a3;
        return y = n.exports, q = y.ma, i1(), D = y.ra, H.unshift(y.na), a1--, (_a3 = s.monitorRunDependencies) == null ? void 0 : _a3.call(s, a1), a1 == 0 && m1 && (n = m1, m1 = null, n()), y;
      }
    ...
    function j2() {
      function t() {
        ...
        if (!j1 && (j1 = true, s.calledRun = true, !s1)) {
          if (N1(H), p(s), (_a2 = s.onRuntimeInitialized) == null ? void 0 : _a2.call(s), s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) {
...
var Z2 = class b {
  ...
  get layout() {
    ...
    if (i) return { align: [i.align.get(0), i.align.get(1)], fit: (() => {
      ...
      switch (i.fit) {
        case ((_a2 = b._wasmModule) == null ? void 0 : _a2.Fit.Contain):
          return "contain";
        case ((_b = b._wasmModule) == null ? void 0 : _b.Fit.Cover):
          return "cover";
        case ((_c = b._wasmModule) == null ? void 0 : _c.Fit.Fill):
          return "fill";
        case ((_d = b._wasmModule) == null ? void 0 : _d.Fit.FitHeight):
          return "fit-height";
        case ((_e = b._wasmModule) == null ? void 0 : _e.Fit.FitWidth):
          return "fit-width";
        case ((_f = b._wasmModule) == null ? void 0 : _f.Fit.None):
          return "none";
        default:
          return "contain";
      }
  ...
  get mode() {
    ...
    return i === ((_b = b._wasmModule) == null ? void 0 : _b.Mode.Reverse) ? "reverse" : i === ((_c = b._wasmModule) == null ? void 0 : _c.Mode.Bounce) ? "bounce" : i === ((_d = b._wasmModule) == null ? void 0 : _d.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  destroy() {
    var _a;
    this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), A && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), X.unobserve(this._canvas)), (_a = this._dotLottieCore) == null ? void 0 : _a.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  static transformThemeToLottieSlots(i, r) {
    var _a;
    return ((_a = b._wasmModule) == null ? void 0 : _a.transformThemeToLottieSlots(i, r)) ?? "";
  }
};
...
var _2 = class r1 {
  ...
  async _create(i) {
    ...
    let { instanceId: s } = await this._sendMessage("create", { instanceId: this._id, config: { ...i, canvas: r }, ...Q2(this._canvas, ((_a = i.renderConfig) == null ? void 0 : _a.devicePixelRatio) || o1()) }, [r]);
...
var Q1 = ({ animationId: d, autoplay: i, backgroundColor: r, className: s, createDotLottie: p, data: P, dotLottieRefCallback: z, layout: F, loop: G, mode: E, playOnHover: l1, renderConfig: u1, segment: $, speed: K, src: q, style: s1, themeData: h1, themeId: B, useFrameInterpolation: M, workerId: t1, ...J }) => {
  ...
  let E1 = (0, import_react.useCallback)((H) => {
    var _a, _b;
    w.current = H, H ? L.current = p({ ...i1.current, canvas: H }) : ((_a = L.current) == null ? void 0 : _a.destroy(), L.current = null), (_b = f1.current) == null ? void 0 : _b.call(f1, L.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    ...
    return (_a = w.current) == null ? void 0 : _a.addEventListener("mouseenter", H), (_b = w.current) == null ? void 0 : _b.addEventListener("mouseleave", H), () => {
      var _a2, _b2;
      (_a2 = w.current) == null ? void 0 : _a2.removeEventListener("mouseenter", H), (_b2 = w.current) == null ? void 0 : _b2.removeEventListener("mouseleave", H);
    };
    ...
    var _a;
    (_a = L.current) == null ? void 0 : _a.setUseFrameInterpolation(M ?? true);
    ...
    var _a;
    typeof P != "string" && typeof P != "object" || ((_a = L.current) == null ? void 0 : _a.load({ data: P, ...i1.current }));
    ...
    var _a;
    typeof B == "string" && ((_a = L.current) == null ? void 0 : _a.setTheme(B));
